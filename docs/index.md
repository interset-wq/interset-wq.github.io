...
> 比如说，我经常忘记 `正则表达式` 的匹配模式，经常忘记字典可以直接使用 `my_dict['key'] = value` 来添加新的键值对，经常忘记谁是 `HTML` `行内元素`，谁是 `块级元素` ……

Tour，有旅行的意思，记得以前英语老师说过tour是指有往返的旅行。

> 孔子曰：温故而知新

所以，我认为学习这场旅行不是一直往前，偶尔也需要回过头来，来到曾经去过的地方，或许又会看到不一样的景色。
...
- [ ] :fontawesome-brands-python: python
    ...
    - [x] :simple-scrapy: 网络爬虫
    - [ ] :material-nintendo-game-boy: pygame
    - [ ] :material-web: Web 开发
